        ...
        <div>
            <div id="entry">
                <div class="entry-content">
                    ...
                    <div class="social_sharing_post"> <a href="https://twitter.com/intent/tweet?url=<?php echo e(url()->current()); ?>" class="twitter"> Twitter</a> <a href="http://www.facebook.com/sharer.php?u=<?php echo e(url()->current()); ?>" class="facebook">Facebook</a> 
                    </div>
                </div>
...
<?php $__env->stopSection(); ?>
<!-- end Page Content -->
<?php echo $__env->make('layout.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\HongDiep\Duan\resources\views/pages/tintuc.blade.php ENDPATH**/ ?>