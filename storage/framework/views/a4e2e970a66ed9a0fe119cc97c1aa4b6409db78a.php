                    ...
                    <div class="col-lg-7" style="padding-bottom:120px">
                        ...
                        <form action="admin/loaitin/sua/<?php echo e($loaitin->id); ?>" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" name="Ten" placeholder="Điền tên loại tin" value=<?php echo e($loaitin->Ten); ?>/>
...
<?php echo $__env->make('admin.layout.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\HongDiep\demo\resources\views/admin/loaitin/sua.blade.php ENDPATH**/ ?>