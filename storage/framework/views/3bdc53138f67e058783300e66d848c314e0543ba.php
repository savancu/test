            ...
            <div class="col-lg-7" style="padding-bottom:120px">
                ...
                <form action="admin/user/sua/<?php echo e($user->id); ?>" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <label class="radio-inline">
                            <input name="quyen" value="1" <?php if($user->quyen == 1): ?>
                            <?php echo e("checked"); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\HongDiep\Duan\resources\views/admin/user/sua.blade.php ENDPATH**/ ?>